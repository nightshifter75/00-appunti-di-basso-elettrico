...
Senza andare nel dettaglio per ora vi basti sapere (se già non ve ne siete resi conto) che la tastiera del basso si ripete. Il primo esercizio di stretching vi fa suonare Bb2-F3-Bb3-F3, poi B2-F#3-B3-F#3, poi C3-G3-C4-G3 e così via. Vi sarete resi conto (con la mano) che non solo le dita hanno la stessa posizione, ma anche che i suoni si *ripetono* in qualche modo.
...
Cercate **sempre** di sentire quello che state suonando e di familiarizzare con i suoni e cercate, anche se lo farete inconsciamente, di percepire le similitudini e di aiutarvi con la melodia di quello che state suonando.
