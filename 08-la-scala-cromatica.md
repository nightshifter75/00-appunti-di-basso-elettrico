...
<p align="justify">Senza andare nel dettaglio per ora vi basti sapere (se già non ve ne siete resi conto) che la tastiera del basso si ripete. Il primo esercizio di stretching vi fa suonare Bb2-F3-Bb3-F3, poi B2-F#3-B3-F#3, poi C3-G3-C4-G3 e così via. Vi sarete resi conto (con la mano) che non solo le dita hanno la stessa posizione, ma anche che i suoni si <i>ripetono</i> in qualche modo.</p>
