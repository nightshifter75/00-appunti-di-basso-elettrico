...
<p align="justify">Attenzione perché esistono anche altri tipi di legature: la legatura di frase è una linea curva posta sopra o sotto tre o più note, con lo scopo di indicare all'esecutore che le note non devono essere suonate staccate una dall'altra, ma unite una subito dopo l'altra, con un'unica emissione di fiato (nel caso degli strumenti a fiato) o facendo scivolare le dita (nel caso del pianoforte o di uno strumento a corda). L'effetto che si crea è detto legato.</p>
